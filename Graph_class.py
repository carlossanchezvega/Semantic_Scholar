...
class Graph_class:
    ...
    def create_graph(self):
        ...
        authors = list((self.collection_authors.find({"_id": {"$in": ids_coauthors}})))
        ...
        ids_publications = list(set(list(itertools.chain.from_iterable([author['publications'] for author in
                            (self.collection_authors.find({"_id": {"$in": ids_coauthors}}))]))))

        publications =list(self.collection_publications.find({"_id": {"$in": ids_publications}}))
